...
function describeError(caught: unknown): string {
  ...
  if (caught instanceof MissingCredentialsError || message.includes("Gateway is not configured")) {
    return "The local Gateway is not configured. Check the server environment and restart.";
  }
  return `Generation failed — ${message}. Try again; if it repeats, check the local Gateway.`;
}
