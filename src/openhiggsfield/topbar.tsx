...
export function Topbar({
  ...
  return (
    <div className="ohf-topbar">
      ...
      {/* The CUA runtime owns the Gateway credential. Keep the hosted status
          capsule, but never expose or edit the server-only key in the browser. */}
      <div className="ohf-bar ohf-enter-1">
        <div
          className="ohf-key"
          data-busy={busy}
          ...
          role="status"
          aria-label={keyConfigured ? "Gateway ready" : "Gateway not configured"}
          title={keyConfigured ? "Gateway ready" : "Gateway not configured"}
        >
          <KeyIcon />
          <span className="ohf-key-text">Gateway</span>
